...
typedef enum {
    ...
    PDF_ERR_DEFLATE_REPEAT_UNDERFLOW,
    PDF_ERR_DEFLATE_REPEAT_OVERFLOW,
    PDF_ERR_DEFLATE_BACKREF_UNDERFLOW,
    PDF_ERR_ZLIB_INVALID_CM,
    PDF_ERR_ZLIB_RESERVED_CM,
    ...
    PDF_ERR_PS_ARRAY_NOT_STARTED,
    PDF_ERR_PS_KEY_MISSING,
    PDF_ERR_PS_OPERANDS_EMPTY,
