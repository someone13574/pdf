...
#define SCHEMA_FIELD_PARSE_REQUIRED(object_type, name, key)                    \
    if (strcmp(entry_key, key) == 0) {                                         \
        ...
        name##_present = true;                                                 \
        out.name = entry_value->data.OBJECT_UNION_FIELD_##object_type;         \
    } else
...
// Schema implementation macro
#define SCHEMA_IMPL(type_name, snake_name, validation_fn, ...)                 \
